  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-20 flex h-16 justify-center border-[#101115] border-b bg-[#141517]/90 backdrop-blur-md pt-2.5 pb-0.5">
        <div
          className={`flex h-full w-full max-w-260 relative items-center px-3 sm:px-4 ${isAuthenticated ? "justify-between" : "justify-center"}`}
        >

          <div className={isAuthenticated ? "flex justify-start" : "flex justify-center"}>
